package com.iuh.HP_toystore.config;
...
import com.iuh.HP_toystore.services.Imls.UserDetailsServiceImpl;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		httpSecurity.authorizeRequests().antMatchers("/ban-hang/don-hang","/ban-hang/san-pham-cua-ban",
				"/ban-hang/them-san-pham-moi","/ban-hang/sua-san-pham/{id}")
		...
		httpSecurity.authorizeRequests()
				...
				.and()
				.authorizeRequests()
				.antMatchers("/dat-hang","/san-pham-danh-gia/{id}","/ban-hang/**").authenticated() // trang nao can dang
																								// nhap roi
